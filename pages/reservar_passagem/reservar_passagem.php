...
<body>
        ...
        <div id="navbar">
            <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    ...
                    <a href="./reservar_passagem/reservar_passagem.php" class="text-sm font-semibold leading-6 text-white in-page">Reservar passagem</a>
    ...
    <main>
        <section class="booking-area">
             <form action="./selecionar_voo_ida.php" method="post"> <!-- Ir para Selecionar voo -->
