    ...
    <form action="./resumo_compra.php" method="post">
            <section class="color-information-area">
                ...
                <div class="occupant-info">
                    ...
                    // REPASSAMENTO DAS INFOS DOS PASSAGEIROS PRA RESUMO_COMPRA.PHP
                    for($i = 0; $i < $total_assentos; $i++) {
                        ...
                        echo '<input type="hidden" id="price-seat-1-'.$i.'" name="price-seat-1-'.$i.'" value="'.$passageiro[$i]['price_seat_1'].'">';
                        ...
                        echo '<input type="hidden" id="seat-2-'.$i.'" name="seat-2-'.$i.'" value="">';
                    ...
                    echo '<input type="hidden" id="viagem" name="flight-selected" value="">';
            ...
            <section class="seats-area">
                ...
                $query_assentos_ocupados = "SELECT * from passagem where fk_voo = $returnFlightId";
