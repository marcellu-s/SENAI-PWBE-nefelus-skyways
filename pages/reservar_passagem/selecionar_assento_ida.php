...
<body>
        ...
        <div id="navbar">
            <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    ...
                    <a href="./reservar_passagem/reservar_passagem.php" class="text-sm font-semibold leading-6 text-white in-page">Selecionar assento</a>
    ...
    <main>
        ...
        // IDS VOOS IDA E VOLTA
        $flightId = $_POST['flight-selected'];
        $returnFlightId = $_POST['return-flight-selected'];

        // SE EXISTE O VOO DE RETORNO, O IF PROCEDE
        if(isset($returnFlightId)) {
            echo '<form action="./selecionar_assento_volta.php" method="post">';
        } else {
            echo '<form action="./resumo_compra.php" method="post">';
        }
        ...
        ?>
            ...
            <section class="color-information-area">
                ...
                <div class="occupant-info">
                    ...
                    for($i = 0; $i < $total_passageiros; $i++) {
                        ...
                        echo '<input type="hidden" id="seat-1-'.$i.'" name="seat-1-'.$i.'" value="">';
                        echo '</div>';
                    }

                    echo '</div>';

                    echo '<input type="hidden" id="viagem" name="flight-selected" value="ida">';

                    echo '<input type="hidden" id="flight-selected" name="flight-selected" value="'.$flightId.'">';
                    echo '<input type="hidden" id="return-flight-selected" name="return-flight-selected" value="'.$returnFlightId.'">';
                    ?>
            ...
            <section class="seats-area">
                ...
                $query_assentos_ocupados = "SELECT * from passagem where fk_voo = $flightId";
